...
},{"fisher":"M0zJQM","jquery":36,"tile":"MtwR2O","underscore":37}],"board":[function(require,module,exports){
...
},{"board":"vrNTnI","fabric":"NlWBxo","fisher":"M0zJQM","jquery":36}],"main":[function(require,module,exports){
...
},{"fabric":"NlWBxo","fisher":"M0zJQM","jquery":36,"underscore":37}],"tile":[function(require,module,exports){
...
describe('Board', function() {
  ...
  return describe('processing tiles for layout', function() {
...
},{"board":"vrNTnI","chai":1,"jquery":36,"underscore":37}],49:[function(require,module,exports){
var $, Board, Tile, expect, fabric, _;
...
describe('Tile', function() {
  ...
  return describe('- 1 tile', function() {
    beforeEach(function() {
      this.board.add_start_tile();
    ...
    it('should be placed', function() {
      expect(this.tile.place()).to.be.ok;
    ...
    return it('should not be placed if there is no room', function() {
      ...
      expect(this.tile.place()).to.be["false"];
      expect(this.tile.x).to.be.undefined;
      return expect(this.tile.y).to.be.undefined;
    });
  });
...
},{"board":"vrNTnI","chai":1,"fabric":"NlWBxo","jquery":36,"tile":"MtwR2O","underscore":37}]},{},[48,49])